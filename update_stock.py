...
TICKER_CELLS = {
    ...
    'QQQ': [(64, 7)],
    # 日本株
    # ※ 20260419 以降 row75 に三菱重工（7011）が追加挿入されたため
    #   row75 以降の全行が +1 シフトしている
    '8001.T': [(72, 7)],   # 伊藤忠
    '8316.T': [(73, 7)],   # 三井住友FG
    '8306.T': [(74, 7)],   # 三菱UFJ
    '7011.T': [(75, 7)],   # 三菱重工(row75); row83=G75 で自動反映
    '9023.T': [(76, 7)],   # 東京地下鉄(9023); row77=G76 で自動反映
    '7013.T': [(78, 7)],   # IHI(7013); row79=G78 で自動反映
    '8303.T': [(80, 7)],   # SBI新生銀行
    '2501.T': [(81, 7)],   # サッポロHD
    '285A.T': [(82, 7)],   # キオクシア
    # 米国株 (参照元セルのみ更新、row87=ヘッダ行のため row88 以降がデータ)
    'GOOG':  [(88, 7)],
    'ISRG':  [(89, 7)],
    'AMZN':  [(90, 7)],
    'MSFT':  [(91, 7)],
    'NVDA':  [(92, 7)],
    'META':  [(93, 7)],
    'GS':    [(95, 7)],    # Goldman Sachs (Yuji)
    'JPM':   [(96, 7)],    # JP Morgan
    'LLY':   [(97, 7)],
    'PLTR':  [(99, 7)],
    'AAPL':  [(106, 7)],   # シートでは APPL と誤記 (Fumi)
    'TSLA':  [(114, 7)],
    'EW':    [(115, 7)],
    'MS':    [(121, 7)],   # Morgan Stanley (Akatsuki)
    # PAWN は上場廃止のため除外
}
